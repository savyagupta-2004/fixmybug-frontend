...
const articleInfo = [
  {
    ...
    authors: [
      { name: "Remy Sharp", avatar: "/static/images/avatar/1.webp" },
      { name: "Travis Howard", avatar: "/static/images/avatar/2.webp" },
    ],
  },
  {
    tag: "Product",
    ...
    authors: [{ name: "Erica Johns", avatar: "/static/images/avatar/6.webp" }],
  },
  {
    tag: "Design",
    ...
    authors: [
      { name: "Kate Morrison", avatar: "/static/images/avatar/7.webp" },
    ],
  },
  {
    tag: "Company",
    ...
    authors: [{ name: "Cindy Baker", avatar: "/static/images/avatar/3.webp" }],
  },
  {
    tag: "Engineering",
    ...
    authors: [
      { name: "Agnes Walker", avatar: "/static/images/avatar/4.webp" },
      { name: "Trevor Henderson", avatar: "/static/images/avatar/5.webp" },
    ],
  },
  {
    tag: "Product",
