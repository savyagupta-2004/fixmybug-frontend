...
export default function ExpandableCardCollection() {
  ...
  return (
    <>
    <h1 className="lg:text-4xl md:text-4xl sm:text-3xl text-3xl font-bold text-center mt-32 mb-10">CHOOSE YOUR<span className="text-[#0c4a6e]"> BugFixer</span></h1>
